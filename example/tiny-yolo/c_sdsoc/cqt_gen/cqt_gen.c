...
//outputs
float *input_1_output; //input_1_output[3][416][416]
float *conv2d_1_output; //conv2d_1_output[16][416][416]
float *batch_normalization_1_output; //batch_normalization_1_output[16][416][416]
float *leaky_re_lu_1_output; //leaky_re_lu_1_output[16][416][416]
float *max_pooling2d_1_output; //max_pooling2d_1_output[16][208][208]
float *conv2d_2_output; //conv2d_2_output[32][208][208]
float *batch_normalization_2_output; //batch_normalization_2_output[32][208][208]
float *leaky_re_lu_2_output; //leaky_re_lu_2_output[32][208][208]
float *max_pooling2d_2_output; //max_pooling2d_2_output[32][104][104]
float *conv2d_3_output; //conv2d_3_output[64][104][104]
float *batch_normalization_3_output; //batch_normalization_3_output[64][104][104]
float *leaky_re_lu_3_output; //leaky_re_lu_3_output[64][104][104]
float *max_pooling2d_3_output; //max_pooling2d_3_output[64][52][52]
float *conv2d_4_output; //conv2d_4_output[128][52][52]
float *batch_normalization_4_output; //batch_normalization_4_output[128][52][52]
float *leaky_re_lu_4_output; //leaky_re_lu_4_output[128][52][52]
float *max_pooling2d_4_output; //max_pooling2d_4_output[128][26][26]
float *conv2d_5_output; //conv2d_5_output[256][26][26]
float *batch_normalization_5_output; //batch_normalization_5_output[256][26][26]
float *leaky_re_lu_5_output; //leaky_re_lu_5_output[256][26][26]
float *max_pooling2d_5_output; //max_pooling2d_5_output[256][13][13]
float *conv2d_6_output; //conv2d_6_output[512][13][13]
float *batch_normalization_6_output; //batch_normalization_6_output[512][13][13]
float *leaky_re_lu_6_output; //leaky_re_lu_6_output[512][13][13]
float *max_pooling2d_6_output; //max_pooling2d_6_output[512][13][13]
float *conv2d_7_output; //conv2d_7_output[1024][13][13]
float *batch_normalization_7_output; //batch_normalization_7_output[1024][13][13]
float *leaky_re_lu_7_output; //leaky_re_lu_7_output[1024][13][13]
float *conv2d_8_output; //conv2d_8_output[1024][13][13]
float *batch_normalization_8_output; //batch_normalization_8_output[1024][13][13]
float *leaky_re_lu_8_output; //leaky_re_lu_8_output[1024][13][13]
float *conv2d_9_output; //conv2d_9_output[125][13][13]
