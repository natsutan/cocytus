        ...
        for(n=0;n<input_size_num;n++) {
            for(y=0;y<input_size_y;y+=2) {
                for(x=0;x<input_size_x;x+=2){
                    ...
                    idx_o = (y / 2) * (input_size_x / 2) * input_size_num + ((x/2) * input_size_num) + n;
                    ...
                    data[0] = *(ip + idx_i);
                    data[1] = *(ip + idx_i + input_size_num);
                    data[2] = *(ip + idx_i + input_size_x * input_size_num);
                    data[3] = *(ip + idx_i + input_size_x * input_size_num + input_size_num);
