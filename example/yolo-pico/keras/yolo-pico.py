...
def tiny_yolo_model():
    ...
    model.add(Conv2D(35, use_bias=True, data_format="channels_last", padding='same', kernel_size=(1, 1), strides=(1, 1)))
...
tiny_yolo_model.load_weights('weight/yolo-pico.h5')

with open('yolo-pico.json', 'w') as fp:
