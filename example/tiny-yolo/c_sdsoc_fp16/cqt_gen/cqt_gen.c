...
FP16 w_conv2d_1_W[16][3][3][3];
FP16 w_conv2d_1_b[16];
...
FP16 beta_batch_normalization_1_W[16];
FP16 gamma_batch_normalization_1_W[16];
FP16 moving_mean_batch_normalization_1_W[16];
FP16 moving_variance_batch_normalization_1_W[16];
NUMPY_HEADER nph_conv2d_2_W;
NUMPY_HEADER nph_conv2d_2_b;
FP16 w_conv2d_2_W[32][16][3][3];
FP16 w_conv2d_2_b[32];
...
FP16 beta_batch_normalization_2_W[32];
FP16 gamma_batch_normalization_2_W[32];
FP16 moving_mean_batch_normalization_2_W[32];
FP16 moving_variance_batch_normalization_2_W[32];
NUMPY_HEADER nph_conv2d_3_W;
NUMPY_HEADER nph_conv2d_3_b;
FP16 w_conv2d_3_W[64][32][3][3];
FP16 w_conv2d_3_b[64];
...
FP16 beta_batch_normalization_3_W[64];
FP16 gamma_batch_normalization_3_W[64];
FP16 moving_mean_batch_normalization_3_W[64];
FP16 moving_variance_batch_normalization_3_W[64];
NUMPY_HEADER nph_conv2d_4_W;
NUMPY_HEADER nph_conv2d_4_b;
FP16 w_conv2d_4_W[128][64][3][3];
FP16 w_conv2d_4_b[128];
...
FP16 beta_batch_normalization_4_W[128];
FP16 gamma_batch_normalization_4_W[128];
FP16 moving_mean_batch_normalization_4_W[128];
FP16 moving_variance_batch_normalization_4_W[128];
NUMPY_HEADER nph_conv2d_5_W;
NUMPY_HEADER nph_conv2d_5_b;
FP16 w_conv2d_5_W[256][128][3][3];
FP16 w_conv2d_5_b[256];
...
FP16 beta_batch_normalization_5_W[256];
FP16 gamma_batch_normalization_5_W[256];
FP16 moving_mean_batch_normalization_5_W[256];
FP16 moving_variance_batch_normalization_5_W[256];
NUMPY_HEADER nph_conv2d_6_W;
NUMPY_HEADER nph_conv2d_6_b;
FP16 w_conv2d_6_W[512][256][3][3];
FP16 w_conv2d_6_b[512];
...
FP16 beta_batch_normalization_6_W[512];
FP16 gamma_batch_normalization_6_W[512];
FP16 moving_mean_batch_normalization_6_W[512];
FP16 moving_variance_batch_normalization_6_W[512];
NUMPY_HEADER nph_conv2d_7_W;
NUMPY_HEADER nph_conv2d_7_b;
FP16 w_conv2d_7_W[1024][512][3][3];
FP16 w_conv2d_7_b[1024];
...
FP16 beta_batch_normalization_7_W[1024];
FP16 gamma_batch_normalization_7_W[1024];
FP16 moving_mean_batch_normalization_7_W[1024];
FP16 moving_variance_batch_normalization_7_W[1024];
NUMPY_HEADER nph_conv2d_8_W;
NUMPY_HEADER nph_conv2d_8_b;
FP16 w_conv2d_8_W[1024][1024][3][3];
FP16 w_conv2d_8_b[1024];
...
FP16 beta_batch_normalization_8_W[1024];
FP16 gamma_batch_normalization_8_W[1024];
FP16 moving_mean_batch_normalization_8_W[1024];
FP16 moving_variance_batch_normalization_8_W[1024];
NUMPY_HEADER nph_conv2d_9_W;
NUMPY_HEADER nph_conv2d_9_b;
FP16 w_conv2d_9_W[125][1024][1][1];
FP16 w_conv2d_9_b[125];

//outputs
FP16 *input_1_output; //input_1_output[3][416][416]
FP16 *conv2d_1_output; //conv2d_1_output[16][416][416]
FP16 *batch_normalization_1_output; //batch_normalization_1_output[16][416][416]
FP16 *leaky_re_lu_1_output; //leaky_re_lu_1_output[16][416][416]
FP16 *max_pooling2d_1_output; //max_pooling2d_1_output[16][208][208]
FP16 *conv2d_2_output; //conv2d_2_output[32][208][208]
FP16 *batch_normalization_2_output; //batch_normalization_2_output[32][208][208]
FP16 *leaky_re_lu_2_output; //leaky_re_lu_2_output[32][208][208]
FP16 *max_pooling2d_2_output; //max_pooling2d_2_output[32][104][104]
FP16 *conv2d_3_output; //conv2d_3_output[64][104][104]
FP16 *batch_normalization_3_output; //batch_normalization_3_output[64][104][104]
FP16 *leaky_re_lu_3_output; //leaky_re_lu_3_output[64][104][104]
FP16 *max_pooling2d_3_output; //max_pooling2d_3_output[64][52][52]
FP16 *conv2d_4_output; //conv2d_4_output[128][52][52]
FP16 *batch_normalization_4_output; //batch_normalization_4_output[128][52][52]
FP16 *leaky_re_lu_4_output; //leaky_re_lu_4_output[128][52][52]
FP16 *max_pooling2d_4_output; //max_pooling2d_4_output[128][26][26]
FP16 *conv2d_5_output; //conv2d_5_output[256][26][26]
FP16 *batch_normalization_5_output; //batch_normalization_5_output[256][26][26]
FP16 *leaky_re_lu_5_output; //leaky_re_lu_5_output[256][26][26]
FP16 *max_pooling2d_5_output; //max_pooling2d_5_output[256][13][13]
FP16 *conv2d_6_output; //conv2d_6_output[512][13][13]
FP16 *batch_normalization_6_output; //batch_normalization_6_output[512][13][13]
FP16 *leaky_re_lu_6_output; //leaky_re_lu_6_output[512][13][13]
FP16 *max_pooling2d_6_output; //max_pooling2d_6_output[512][13][13]
FP16 *conv2d_7_output; //conv2d_7_output[1024][13][13]
FP16 *batch_normalization_7_output; //batch_normalization_7_output[1024][13][13]
FP16 *leaky_re_lu_7_output; //leaky_re_lu_7_output[1024][13][13]
FP16 *conv2d_8_output; //conv2d_8_output[1024][13][13]
FP16 *batch_normalization_8_output; //batch_normalization_8_output[1024][13][13]
FP16 *leaky_re_lu_8_output; //leaky_re_lu_8_output[1024][13][13]
FP16 *conv2d_9_output; //conv2d_9_output[125][13][13]
...
CQT_NET* cqt_init(void) {
	...
	g_cqt_sequential_1.layer[0].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[0].output_dtypes[0] = CQT_FLOAT16;
	...
	input_1_output = (FP16 *)sds_alloc(3 * 416 * 416 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[1].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[1].weight_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[1].output_dtypes[0] = CQT_FLOAT16;
	...
	conv2d_1_output = (FP16 *)sds_alloc(16 * 416 * 416 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[2].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[2].weight_dtypes[0] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[2].weight_dtypes[1] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[2].weight_dtypes[2] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[2].weight_dtypes[3] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[2].output_dtypes[0] = CQT_FLOAT16;
	...
	batch_normalization_1_output = (FP16 *)sds_alloc(16 * 416 * 416 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[3].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[3].output_dtypes[0] = CQT_FLOAT16;
	...
	leaky_re_lu_1_output = (FP16 *)sds_alloc(16 * 416 * 416 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[4].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[4].output_dtypes[0] = CQT_FLOAT16;
	...
	max_pooling2d_1_output = (FP16 *)sds_alloc(16 * 208 * 208 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[5].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[5].weight_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[5].output_dtypes[0] = CQT_FLOAT16;
	...
	conv2d_2_output = (FP16 *)sds_alloc(32 * 208 * 208 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[6].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[6].weight_dtypes[0] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[6].weight_dtypes[1] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[6].weight_dtypes[2] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[6].weight_dtypes[3] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[6].output_dtypes[0] = CQT_FLOAT16;
	...
	batch_normalization_2_output = (FP16 *)sds_alloc(32 * 208 * 208 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[7].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[7].output_dtypes[0] = CQT_FLOAT16;
	...
	leaky_re_lu_2_output = (FP16 *)sds_alloc(32 * 208 * 208 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[8].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[8].output_dtypes[0] = CQT_FLOAT16;
	...
	max_pooling2d_2_output = (FP16 *)sds_alloc(32 * 104 * 104 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[9].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[9].weight_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[9].output_dtypes[0] = CQT_FLOAT16;
	...
	conv2d_3_output = (FP16 *)sds_alloc(64 * 104 * 104 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[10].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[10].weight_dtypes[0] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[10].weight_dtypes[1] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[10].weight_dtypes[2] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[10].weight_dtypes[3] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[10].output_dtypes[0] = CQT_FLOAT16;
	...
	batch_normalization_3_output = (FP16 *)sds_alloc(64 * 104 * 104 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[11].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[11].output_dtypes[0] = CQT_FLOAT16;
	...
	leaky_re_lu_3_output = (FP16 *)sds_alloc(64 * 104 * 104 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[12].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[12].output_dtypes[0] = CQT_FLOAT16;
	...
	max_pooling2d_3_output = (FP16 *)sds_alloc(64 * 52 * 52 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[13].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[13].weight_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[13].output_dtypes[0] = CQT_FLOAT16;
	...
	conv2d_4_output = (FP16 *)sds_alloc(128 * 52 * 52 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[14].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[14].weight_dtypes[0] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[14].weight_dtypes[1] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[14].weight_dtypes[2] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[14].weight_dtypes[3] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[14].output_dtypes[0] = CQT_FLOAT16;
	...
	batch_normalization_4_output = (FP16 *)sds_alloc(128 * 52 * 52 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[15].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[15].output_dtypes[0] = CQT_FLOAT16;
	...
	leaky_re_lu_4_output = (FP16 *)sds_alloc(128 * 52 * 52 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[16].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[16].output_dtypes[0] = CQT_FLOAT16;
	...
	max_pooling2d_4_output = (FP16 *)sds_alloc(128 * 26 * 26 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[17].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[17].weight_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[17].output_dtypes[0] = CQT_FLOAT16;
	...
	conv2d_5_output = (FP16 *)sds_alloc(256 * 26 * 26 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[18].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[18].weight_dtypes[0] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[18].weight_dtypes[1] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[18].weight_dtypes[2] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[18].weight_dtypes[3] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[18].output_dtypes[0] = CQT_FLOAT16;
	...
	batch_normalization_5_output = (FP16 *)sds_alloc(256 * 26 * 26 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[19].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[19].output_dtypes[0] = CQT_FLOAT16;
	...
	leaky_re_lu_5_output = (FP16 *)sds_alloc(256 * 26 * 26 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[20].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[20].output_dtypes[0] = CQT_FLOAT16;
	...
	max_pooling2d_5_output = (FP16 *)sds_alloc(256 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[21].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[21].weight_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[21].output_dtypes[0] = CQT_FLOAT16;
	...
	conv2d_6_output = (FP16 *)sds_alloc(512 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[22].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[22].weight_dtypes[0] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[22].weight_dtypes[1] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[22].weight_dtypes[2] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[22].weight_dtypes[3] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[22].output_dtypes[0] = CQT_FLOAT16;
	...
	batch_normalization_6_output = (FP16 *)sds_alloc(512 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[23].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[23].output_dtypes[0] = CQT_FLOAT16;
	...
	leaky_re_lu_6_output = (FP16 *)sds_alloc(512 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[24].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[24].output_dtypes[0] = CQT_FLOAT16;
	...
	max_pooling2d_6_output = (FP16 *)sds_alloc(512 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[25].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[25].weight_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[25].output_dtypes[0] = CQT_FLOAT16;
	...
	conv2d_7_output = (FP16 *)sds_alloc(1024 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[26].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[26].weight_dtypes[0] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[26].weight_dtypes[1] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[26].weight_dtypes[2] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[26].weight_dtypes[3] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[26].output_dtypes[0] = CQT_FLOAT16;
	...
	batch_normalization_7_output = (FP16 *)sds_alloc(1024 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[27].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[27].output_dtypes[0] = CQT_FLOAT16;
	...
	leaky_re_lu_7_output = (FP16 *)sds_alloc(1024 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[28].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[28].weight_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[28].output_dtypes[0] = CQT_FLOAT16;
	...
	conv2d_8_output = (FP16 *)sds_alloc(1024 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[29].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[29].weight_dtypes[0] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[29].weight_dtypes[1] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[29].weight_dtypes[2] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[29].weight_dtypes[3] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[29].output_dtypes[0] = CQT_FLOAT16;
	...
	batch_normalization_8_output = (FP16 *)sds_alloc(1024 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[30].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[30].output_dtypes[0] = CQT_FLOAT16;
	...
	leaky_re_lu_8_output = (FP16 *)sds_alloc(1024 * 13 * 13 * sizeof(FP16));
	...
	g_cqt_sequential_1.layer[31].input_dtypes[0] = CQT_FLOAT16;
	...
	g_cqt_sequential_1.layer[31].weight_dtypes[0] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[31].weight_dtypes[1] = CQT_FLOAT16;
	g_cqt_sequential_1.layer[31].weight_dtypes[2] = CQT_DTYPE_NONE;
	g_cqt_sequential_1.layer[31].weight_dtypes[3] = CQT_DTYPE_NONE;
	g_cqt_sequential_1.layer[31].output_dtypes[0] = CQT_FLOAT16;
	...
	conv2d_9_output = (FP16 *)sds_alloc(125 * 13 * 13 * sizeof(FP16));
...
int cqt_run(CQT_NET* np, void *dp) {
	...
	//input_1
	cqt_process = 0;
	ret = CQT_InputLayer_ifp16_ofp16(&(g_cqt_sequential_1.layer[0]), dp, input_1_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//batch_normalization_1
	cqt_process = 2;
	ret = CQT_BatchNormalization_ifp16_wfp16_wfp16_wfp16_wfp16_ofp16(&(g_cqt_sequential_1.layer[2]), conv2d_1_output, batch_normalization_1_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//leaky_re_lu_1
	cqt_process = 3;
	ret = CQT_LeakyReLU_ifp16_ofp16(&(g_cqt_sequential_1.layer[3]), batch_normalization_1_output, leaky_re_lu_1_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//max_pooling2d_1
	cqt_process = 4;
	ret = CQT_MaxPooling2D_ifp16_ofp16(&(g_cqt_sequential_1.layer[4]), leaky_re_lu_1_output, max_pooling2d_1_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//batch_normalization_2
	cqt_process = 6;
	ret = CQT_BatchNormalization_ifp16_wfp16_wfp16_wfp16_wfp16_ofp16(&(g_cqt_sequential_1.layer[6]), conv2d_2_output, batch_normalization_2_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//leaky_re_lu_2
	cqt_process = 7;
	ret = CQT_LeakyReLU_ifp16_ofp16(&(g_cqt_sequential_1.layer[7]), batch_normalization_2_output, leaky_re_lu_2_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//max_pooling2d_2
	cqt_process = 8;
	ret = CQT_MaxPooling2D_ifp16_ofp16(&(g_cqt_sequential_1.layer[8]), leaky_re_lu_2_output, max_pooling2d_2_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//batch_normalization_3
	cqt_process = 10;
	ret = CQT_BatchNormalization_ifp16_wfp16_wfp16_wfp16_wfp16_ofp16(&(g_cqt_sequential_1.layer[10]), conv2d_3_output, batch_normalization_3_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//leaky_re_lu_3
	cqt_process = 11;
	ret = CQT_LeakyReLU_ifp16_ofp16(&(g_cqt_sequential_1.layer[11]), batch_normalization_3_output, leaky_re_lu_3_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//max_pooling2d_3
	cqt_process = 12;
	ret = CQT_MaxPooling2D_ifp16_ofp16(&(g_cqt_sequential_1.layer[12]), leaky_re_lu_3_output, max_pooling2d_3_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//batch_normalization_4
	cqt_process = 14;
	ret = CQT_BatchNormalization_ifp16_wfp16_wfp16_wfp16_wfp16_ofp16(&(g_cqt_sequential_1.layer[14]), conv2d_4_output, batch_normalization_4_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//leaky_re_lu_4
	cqt_process = 15;
	ret = CQT_LeakyReLU_ifp16_ofp16(&(g_cqt_sequential_1.layer[15]), batch_normalization_4_output, leaky_re_lu_4_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//max_pooling2d_4
	cqt_process = 16;
	ret = CQT_MaxPooling2D_ifp16_ofp16(&(g_cqt_sequential_1.layer[16]), leaky_re_lu_4_output, max_pooling2d_4_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//batch_normalization_5
	cqt_process = 18;
	ret = CQT_BatchNormalization_ifp16_wfp16_wfp16_wfp16_wfp16_ofp16(&(g_cqt_sequential_1.layer[18]), conv2d_5_output, batch_normalization_5_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//leaky_re_lu_5
	cqt_process = 19;
	ret = CQT_LeakyReLU_ifp16_ofp16(&(g_cqt_sequential_1.layer[19]), batch_normalization_5_output, leaky_re_lu_5_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//max_pooling2d_5
	cqt_process = 20;
	ret = CQT_MaxPooling2D_ifp16_ofp16(&(g_cqt_sequential_1.layer[20]), leaky_re_lu_5_output, max_pooling2d_5_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//batch_normalization_6
	cqt_process = 22;
	ret = CQT_BatchNormalization_ifp16_wfp16_wfp16_wfp16_wfp16_ofp16(&(g_cqt_sequential_1.layer[22]), conv2d_6_output, batch_normalization_6_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//leaky_re_lu_6
	cqt_process = 23;
	ret = CQT_LeakyReLU_ifp16_ofp16(&(g_cqt_sequential_1.layer[23]), batch_normalization_6_output, leaky_re_lu_6_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//max_pooling2d_6
	cqt_process = 24;
	ret = CQT_MaxPooling2D_ifp16_ofp16(&(g_cqt_sequential_1.layer[24]), leaky_re_lu_6_output, max_pooling2d_6_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//batch_normalization_7
	cqt_process = 26;
	ret = CQT_BatchNormalization_ifp16_wfp16_wfp16_wfp16_wfp16_ofp16(&(g_cqt_sequential_1.layer[26]), conv2d_7_output, batch_normalization_7_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//leaky_re_lu_7
	cqt_process = 27;
	ret = CQT_LeakyReLU_ifp16_ofp16(&(g_cqt_sequential_1.layer[27]), batch_normalization_7_output, leaky_re_lu_7_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//batch_normalization_8
	cqt_process = 29;
	ret = CQT_BatchNormalization_ifp16_wfp16_wfp16_wfp16_wfp16_ofp16(&(g_cqt_sequential_1.layer[29]), conv2d_8_output, batch_normalization_8_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//leaky_re_lu_8
	cqt_process = 30;
	ret = CQT_LeakyReLU_ifp16_ofp16(&(g_cqt_sequential_1.layer[30]), batch_normalization_8_output, leaky_re_lu_8_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
	...
	//conv2d_9
	cqt_process = 31;
	ret = CQT_Conv2D_same_1x1_ifp16_wfp16_wfp16_ofp16(&(g_cqt_sequential_1.layer[31]), leaky_re_lu_8_output, conv2d_9_output);
	if(ret != CQT_RET_OK){
		return ret;
	}
